 ...
 * 7. validate: 콜백 함수를 인수로 전달하여 유효성을 검사하거나 콜백 함수의 객체를 전달하여 모두 유효성을 검사 할 수 있습니다. (예제 참조) 참고 : 대한 또는 데이터 입력, 그것은 사용하는 것이 좋습니다의 다른 규칙의 대부분에 적용되는 유효성 검사 기능을 , 그리고 데이터 유형입니다.
 */
